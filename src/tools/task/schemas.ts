...
import { z } from 'zod';
import { VisStateSchema, MoneySchema, BusinessIdSchema } from '../base-tool.js';
 ...
 */
export const TaskCreateInputSchema = BusinessIdSchema.extend({
 ...
 */
export const TaskUpdateInputSchema = BusinessIdSchema.extend({
 ...
 */
export const TaskSingleInputSchema = BusinessIdSchema.extend({
 ...
 */
export const TaskDeleteInputSchema = BusinessIdSchema.extend({
